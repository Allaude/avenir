...
<div style="clear:both;">
    <table>
        ...
        if (!empty($db_settings)) {
            ...
            <tr>
                <th>DB Driver:</th>
                <td><?php (isset($db_settings['driver']) ? $driver = $db_settings['driver'] : $driver = ''); echo $driver; ; ?></td>
            </tr>
            <tr>
                <th>DB Prefix:</th>
            ...
            <tr>
                <th>Autoinit:</th>
                <td><?php (isset($db_settings['autoinit']) ? $init = $db_settings['autoinit'] : $init = ''); echo $init; ?></td>
            </tr>
            <tr>
                <th>Encrypt:</th>
